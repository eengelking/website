...
<div class="tldr">
  ...
  <ul>
    <li>A customer's production system went down hard on a storage failure. Their backup plan looked textbook: weekly fulls with daily deltas, rotated offsite for years.</li>
    <li>Every full backup we tried, going back months, came back corrupt or unreadable the moment a real restore was attempted.</li>
    <li>The schedule had been followed to the letter. Nobody had ever confirmed a tape could actually be restored from.</li>
  </ul>
</div>
