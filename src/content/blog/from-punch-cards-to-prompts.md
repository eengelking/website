...
Hopper had the same fight in 1952: she had a running compiler and, in her own words, "nobody would touch it… they carefully told me computers could only do arithmetic. They could not do programs." It took about two years to get it accepted, and the objection wasn't that the output was wrong, it was that a machine doing the job at all seemed impossible ([ETHW, "A-0 Compiler and Initial Development of Automatic Programming, 1951-1952"](https://ethw.org/Milestones:A-0_Compiler_and_Initial_Development_of_Automatic_Programming,_1951-1952)).
